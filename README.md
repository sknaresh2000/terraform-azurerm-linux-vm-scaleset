...
| <a name="input_initial_instance_count"></a> [initial\_instance\_count](#input\_initial\_instance\_count) | The number of Virtual Machines in the Scale Set | `number` | `1` | no |
